    ...
    <main className="flex min-h-screen bg-white">
        ...
        <div className="relative z-10 flex w-full flex-col justify-between p-14 xl:p-20">
          ...
          <div className="max-w-[500px]">
            ...
            <p className="mt-6 max-w-[440px] font-nunito-sans text-[16px] leading-7 text-white/80">
              Create your dashboard account and start managing the website content.
            </p>
          </div>
      ...
      <div className="flex w-full items-center justify-center px-6 py-12 lg:w-1/2 lg:px-12">
        <div className="w-full max-w-[430px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {error && (
              <div className="rounded-[8px] border border-red-200 bg-red-50 px-4 py-3">
                <p className="font-nunito-sans text-[13px] text-red-600">{error}</p>
              </div>
            )}
          ...
          <p className="mt-6 text-center font-nunito-sans text-[13px] text-[#0d1e1e]/60">
            Already have an account?{" "}
            <Link href="/login" className="font-semibold text-[#439897] underline-offset-4 hover:underline">
              Sign in
            </Link>
          </p>
        </div>
